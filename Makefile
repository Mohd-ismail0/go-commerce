...
.PHONY: sqlc-generate sqlc-check openapi-check test test-local integration-test check build lint vet vuln docker-build up down migrate
...
check: openapi-check sqlc-check vet lint test
